...
export default function OrbitScene() {
  useEffect(() => {
    ...
    function animateScene() {
      ...
      const orbitScene = document.querySelector(".orbit-scene-root");
      const vortexGlow = document.querySelector(".vortex-glow-node");
      const haze = document.querySelectorAll(
        ".scene-haze-a-node, .scene-haze-b-node"
      );
      const orbitBlur = document.querySelectorAll(".orbit-blur-node");
  ...
  return (
    <div className={styles.sceneAosWrap}>
      <div className={`${styles.orbitScene} orbit-scene-root`}>
        <div
        ...
        <div className={`${styles.vortexGlow} vortex-glow-node`}></div>

        <div className={styles.vortexShadow}>
          <img
            src="/images/Ellipse 6.png"
            alt=""
            className={styles.vortexShadowImage}
          />
        </div>
        ...
        >
          ...
          <g className={styles.orbitMovingIcons}>
            <g
              className={`${styles.orbitIcon} ${styles.orbitIconMoving} js-orbit-icon`}
